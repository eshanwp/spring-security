...
import com.boot.security.auth.captcha.ICaptchaService;
...
public class RegistrationCaptchaController {
    ...
    @ResponseBody
    public GenericResponse captchaRegisterUserAccount(@Valid final UserDto userDto, final HttpServletRequest request) {
